...
<div class="bg-gradient-to-br from-sky-50 to-blue-50 p-8 rounded-2xl border-l-4 border-gradient-to-b from-sky-400 to-blue-400 shadow-lg">
	...
	<table class="w-full">
		<tbody>
			<tr class="border-b border-sky-200 hover:bg-sky-50 transition-colors">
				...
				<td class="py-3 text-right font-mono text-gray-800 font-semibold">{formatCurrency(totalExpected)}</td>
			</tr>
			<tr class="border-b border-sky-200 hover:bg-sky-50 transition-colors">
				<td class="py-3 font-medium text-gray-800">Total Rent Collected</td>
				<td class="py-3 text-right font-mono text-gray-800 font-semibold">{formatCurrency(totalCollected)}</td>
			</tr>
			<tr class="border-b border-sky-200 hover:bg-sky-50 transition-colors">
				<td class="py-3 font-medium text-gray-800">Outstanding Balance</td>
				<td class="py-3 text-right font-mono text-rose-600 font-semibold">{formatCurrency(outstandingBalance)}</td>
			</tr>
			<tr class="border-b border-sky-200 hover:bg-sky-50 transition-colors">
				<td class="py-3 font-medium text-gray-800">Total Expenses</td>
				<td class="py-3 text-right font-mono text-gray-800 font-semibold">{formatCurrency(totalExpenses)}</td>
			</tr>
			<tr class="bg-gradient-to-r from-emerald-100 to-green-100 rounded-lg">
				<td class="py-4 font-bold text-gray-800 rounded-l-lg">Net Income Available for Distribution</td>
